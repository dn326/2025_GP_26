...
import '../business/models/profile_form_model.dart';
                                    ...
                                    children: [
                                      TextFormField(
                                        ...
                                        decoration: inputDecoration(
                                          context,
                                          isError: _showErrors &&
                                              (_validateWebsite(_model.businessWebsiteTextController?.text) != null),
                                        ),
                                        style: t.bodyLarge.copyWith(color: t.primaryText),
                                        textAlign: TextAlign.start,
                                      ),
                                      ...
                                      if (_showErrors &&
                                        ...
                                        const Padding(
                                          ...
                                          child: Text(
                                            'رابط الموقع الإلكتروني غير صحيح. يجب أن يبدأ بـ http أو https.',
