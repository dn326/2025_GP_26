...
class BusinessProfileFormModel
  ...
  TextEditingController? commercialRegisterTextController;
  ...
  void initState(BuildContext context) {
    ...
    commercialRegisterTextController ??= TextEditingController();
    commercialRegisterFocusNode ??= FocusNode();
    businessWebsiteTextController ??= TextEditingController();
    businessWebsiteFocusNode ??= FocusNode();
