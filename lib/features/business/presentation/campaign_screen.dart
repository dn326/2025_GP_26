  ...
  Future<void> _saveCampaign() async {
    ...
    try {
      ...
      */
      ...
      if (_isEdit) {
        final platformNamesList =
            _platformRows.where((r) => r.platform != null).map((r) => r.platform!.nameAr).toList();
                  ...
                  decoration: BoxDecoration(
                    color: _isEdit && _model.datePicked1 != null
                        ? (_model.datePicked1!.isBefore(DateTime.now())
                            ? const Color(0xFFFEE2E2) // Light red if campaign expired
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: _model.datePicked2 == null
                                                            ? null
                                                            : () async {
                                                        ...
                                                        options: FFButtonOptions(
                                                          ...
                                                          borderSide: BorderSide(
                                                              color:
                                                                  _model.datePicked2 == null ? Colors.grey : t.tertiary,
                                                              width: 2),
                                                          borderRadius: BorderRadius.circular(12),
                                                        ),
                                                      ),
                                                          ...
                                                          if (picked != null) {
                                                            setState(
                                                              () {
                                                                ...
                                                                if (_model.datePicked1 != null &&
                                                                    _model.datePicked1!.isBefore(_model.datePicked2!)) {
            ...
            child: Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    value,
                    style: t.bodyMedium.copyWith(color: const Color(0xFF9CA3AF), fontStyle: FontStyle.italic),
                    textAlign: TextAlign.end,
